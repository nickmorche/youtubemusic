  ...
  <script>
    $(document).ready(function() {
      $().ready(function() {
        ...
        // Ao clicar em um card de música, aparece o player
        $('.music').click(function(){
          // $(".music-player").show();
          $(".music-player").slideDown(500);
          // $("#display").slideUp(800);  // diminui
        });

        $('.icon-triangle-right-17').click(function(){
          $('.icon-triangle-right-17').hide();
          $('.icon-button-pause').show();
        });

        $('.icon-button-pause').click(function(){
          $('.icon-button-pause').hide();
          $('.icon-triangle-right-17').show();
        });
